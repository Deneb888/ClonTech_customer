...
namespace Anitoa
{
    public class CCurveShow
    {
        ...
        public float[] log_threshold = new float[] { 0.08f, 0.08f, 0.08f, 0.08f };      // It is actually percent threshold
        ...
        private double PIVOT_RATIO = 0.5;
...
//          }
        ...
        private void PivotBase(ref double[] yData, int size, int i, int j)        
        {
            ...
            double slope = polyfit2.Coeff[1] * PIVOT_RATIO;
        ...
        public void CheckFalsePositive(int iy)
        {
            ...
            for (int frameindex = 0; frameindex < numWells; frameindex++)
            {
                ...
                confi = ratio_k * 0.85 + (ratio_eff - 0.3) * 1.43 * 0.15;       // Weighted average of 2 score, r generally range 0.19 to 0.65
