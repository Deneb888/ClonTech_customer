...
namespace Anitoa
{
    public class Protocol
    {
        ...
        // This will reset the ImageCtrl FW
        public byte[] ResetParams(DeviceManagement myDevManager)
        {
            byte[] inputdatas = new byte[64];
            byte[] TxData = new byte[9];
            TxData[0] = 0xaa;		//preamble code
        ...
        // This will reset the TmpCtrl FW
        public byte[] ResetParamsTempCtrl(DeviceManagement myDevManager)
        {
            byte[] inputdatas = new byte[64];
            byte[] TxData = new byte[9];
            TxData[0] = 0xaa;		//preamble code
            TxData[1] = 0x01;		//command
            TxData[2] = 0x03;		//data length
            TxData[3] = 0x29;		//data type, dat edit first byte
            TxData[4] = 0x01;		//real data, data edit second byte
            TxData[5] = 0x00;		//real data, data edit third byte            
            ...
            myDevManager.InputAndOutputReports(0, false, TxData, ref inputdatas, 3000);
            return inputdatas;
        }
...
//            string res = this.BytesToString(inputdatas, 0, inputdatas.Length, "0x", " ", 16);
        ...
        private float UpConvert(float x)
        {
            float dx = 0;
